...
export const Hero2 = () => {
    return (
        <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:mx-[135px] mx-[30px] ">
                <div className="mb-10">
                    <img className="mb-5" src="/d1.png"></img>
                    <h1 className="font-[700] text-[24px] mb-5">
                        Exchange ideas
                    </h1>
                    <p className="text-balance font-[400] text-[14px] text-black text-opacity-70">
                ...
                <div className="mb-10">
                    <img className="mb-5" src="/d2.png"></img>
                    <h1 className="font-[700] text-[24px] mb-5">Marketing</h1>
                    <p className="text-balance font-[400] text-[14px] text-black text-opacity-70">
                ...
                <div className="mb-10">
                    <img className="mb-5" src="/d3.png"></img>
                    <h1 className="font-[700] text-[24px] mb-5">Designing</h1>
                    <p className="text-balance font-[400] text-[14px] text-black text-opacity-70">
                        Pellentesque non ipsum mauris. Vestibulum quis nulla
                        sagittis, venenatis nulla ut, mollis leo. Sed dignissim
                        orci arcu, nec volutpat quam lobortis et
                ...
                <div className="mb-10">
                    <img className="mb-5" src="/d4.png"></img>
                    <h1 className="font-[700] text-[24px] mb-5">
                        Presentation
                    </h1>
                    <p className="text-balance font-[400] text-[14px] text-black text-opacity-70">
