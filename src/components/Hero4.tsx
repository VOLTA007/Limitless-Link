...
export const Hero4 = () => {
    return (
        <section className="mt-[125px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mx-[30px] md:mx-[135px] gap-14">
                <img src="/Dummy 4.png"></img>
                <img src="/Dummy 5.png"></img>
                <img src="/Dummy 6.png"></img>
                <img src="/Dummy 7.png"></img>
            </div>
